...
from utils import *
from transmit import transfer_file,check_file_exists
...
init_model_dir = '/data/FL/models/init_model'
global_model_dir = '/data/FL/models/global_models'
local_model_dir = '/data/FL/models/local_models'
...
global_model.load_state_dict(torch.load(os.path.join(init_model_dir,'init_model.pth')))
